...
class Cliente extends \App\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'apellidos', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'telefono', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'reservas', '' . "\0" . 'App\\Entity\\Cliente' . "\0" . 'roles'];
        }
