 ...
 */
class Tatuador extends \App\Entity\Tatuador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tatuador $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPassword(string $password): \App\Entity\Tatuador
    {
